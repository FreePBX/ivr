...
<div class="section" data-id="ivrdtmf">
	...
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						<div class="col-md-3">
							<label class="control-label" for="accept_pound_key"><?php echo _("Ignore Trailing # Key") ?></label>
		...
		<div class="row">
			<div class="col-md-12">
				<span id="accept_pound_key-help" class="help-block fpbx-help-block"><?php echo _("When enabled, callers can enter a trailing # and it will not be considered part of the IVR entry.")?></span>
			</div>
		</div>
	</div>
	<!--END Accept pound/hash key-->
	<!--Strict Dial Timeout-->
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
